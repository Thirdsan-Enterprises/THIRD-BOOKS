<?php
// ── quarantine2.php — one-off: move the Aug 9 broken (journals=1) backups
// out of the active backups/ folder too, so pull.php serves the real
// 07 Jul backup as "latest" again. Moves, never deletes.
require 'config.php';
