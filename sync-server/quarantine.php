<?php
// ── quarantine.php — one-off: move the known-broken (journals=1) backups
// out of the active backups/ folder so pull.php naturally serves the last
// known-good backup as "latest" again. Moves, never deletes — recoverable.
require 'config.php';
...
foreach ($files as $f) {
    ...
    // Known-broken: far fewer journal entries than any real backup ever had.
