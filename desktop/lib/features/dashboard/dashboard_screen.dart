    ...
    return Row(
      children: [
        Expanded(
          child: _KPICard(
            title: 'Total Cash In',
            value: _formatCurrency(data.cashIn),
            change: 'Total bets placed',
            isPositive: data.cashIn > 0,
        ...
        Expanded(
          child: _KPICard(
            ...
            value: _formatCurrency(data.cashOut),
            change: 'Total winnings paid',
            isPositive: false,
        ...
        Expanded(
          child: _KPICard(
            title: 'Total GGR',
            value: _formatCurrency(data.netCash),
            change: 'Gross Gaming Revenue',
            isPositive: data.netCash >= 0,
